...
class GSRSettingsActivity : AppCompatActivity() {
    ...
    private fun setupSpinners() {
        ...
        gsrSamplingRateSpinner.adapter =
    ...
    private fun setupListeners() {
        ...
        gsrSamplingRateSpinner.onItemSelectedListener =
