...
//        Log.e(TAG, "[onInAppMessageClick] 用户click了notification栏button")
//    }
//
//    override fun onMultiActionClicked(context: Context?, intent: Intent) {
//        Log.e(TAG, "[onMultiActionClicked] 用户click了notification栏button")
//        setZeroBadgeNumber()
...
//            Log.e(TAG, "[onMultiActionClicked] 用户clicknotification栏button一")
//        } else if (nActionExtra == "my_extra2") {
//            Log.e(TAG, "[onMultiActionClicked] 用户clicknotification栏button二")
//        } else if (nActionExtra == "my_extra3") {
//            Log.e(TAG, "[onMultiActionClicked] 用户clicknotification栏button三")
//        } else {
//            Log.e(TAG, "[onMultiActionClicked] 用户clicknotification栏button未定义")
//        }
//    }
//
