...
class StructuredLogger private constructor(private val context: Context) {
    ...
    companion object {
        ...
        // Convenience methods
        fun logInfo(component: String, event: String, details: Map<String, Any> = emptyMap()) {
            instance?.log(LogLevel.INFO, component, event, details)
        }
        
        fun logWarning(component: String, event: String, details: Map<String, Any> = emptyMap()) {
            instance?.log(LogLevel.WARNING, component, event, details)
        }
        
        fun logError(component: String, event: String, details: Map<String, Any> = emptyMap()) {
            instance?.log(LogLevel.ERROR, component, event, details)
        }
        
        fun logDebug(component: String, event: String, details: Map<String, Any> = emptyMap()) {
    ...
    private fun initializeLogging() {
        try {
            ...
            // Log initialization
            log(LogLevel.INFO, "StructuredLogger", "logging_initialized", mapOf(
    ...
    private fun rotateLogFile() {
        try {
            ...
            log(LogLevel.INFO, "StructuredLogger", "log_file_rotated", mapOf(
