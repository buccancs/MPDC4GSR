...
class EnhancedTimeSyncService(
    ...
    fun start(onSyncCompleted: (SyncResult) -> Unit) {
        ...
        syncJob.set(GlobalScope.launch {
            ...
            try {
                ...
                logger.log(StructuredLogger.LogLevel.ERROR, "EnhancedTimeSyncService", "service_error", mapOf(
    ...
    private suspend fun performSynchronization(rounds: Int, isInitial: Boolean) { /* ... */ }
