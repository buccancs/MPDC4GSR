...
class RecordingControllerTest {
    ...
    private fun createMockStats(sensorId: String, sensorType: String): RecordingStats {
    ...
    @Test
    fun `test all sensors start successfully`() = testScope.runTest {
    ...
    @Test
    fun `test partial sensor start - RGB and Thermal succeed, GSR fails`() = testScope.runTest {
    ...
    @Test
    fun `test sensor start with exception - should not crash session`() = testScope.runTest {
    ...
    @Test
    fun `test all sensors fail - session should not start`() = testScope.runTest {
    ...
    @Test
    fun `test sensor status summary reflects reality`() = testScope.runTest {
