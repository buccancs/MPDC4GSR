...
class CommonComponentTest {
    ...
    @Test
    fun testCommonUtilities() = runTest {
    ...
    @Test
    fun testMathOperations() = runTest {
    ...
    @Test
    fun testCoordinateTransformations() = runTest {
    ...
    fun testCollectionOperations() = runTest {
        ...
        assertTrue("All mapped values should be doubled", 
            testList.zip(doubled).all { (original, mapped) -> mapped == original * 2 })
    }
    
    @Test
    fun testStringOperations() = runTest {
