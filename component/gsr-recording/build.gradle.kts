...
dependencies {
    ...
    // implementation(files("libs/ShimmerBiophysicalProcessingLibrary_Rev_0_11.jar")) // Commented out - conflicts with shimmer library
    // implementation(files("libs/AndroidBluetoothLibrary.jar")) // Commented out - conflicts with shimmer library
    // implementation(files("libs/androidplot-core-0.5.0-release.jar")) // Commented out - conflicts with shimmer library
