...
class SessionManagerTest {
    ...
    @Test
    fun testGetActiveSession() = runTest {
    ...
    @Test
    fun testGetSessionInfo() = runTest {
    ...
    @Test
    fun testSessionMetadata() = runTest {
    ...
    fun testSessionLifecycle() = runTest {
        ...
        assertTrue("Session 1 should not be in active sessions or should be inactive", 
