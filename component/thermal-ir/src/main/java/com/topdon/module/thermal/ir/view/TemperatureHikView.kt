...
用于temperature及画arearotationparameter的尺寸.
    ...
    /**
上一次执行temperaturearray回调的时间戳，用于控制 1 秒回调 1 次.
     */
