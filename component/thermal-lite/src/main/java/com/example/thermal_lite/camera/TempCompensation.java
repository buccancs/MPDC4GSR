...
是否启动了流程
    ...
    /**
公式parametery=−0.0705571⋅x2+14.72725379⋅x−30.49372144
     */
...
打快门后记录NUC_neW=ΔNUC
                    ...
                    Log.d(TAG, "temperature补偿exception=" + e.getMessage());
                }
            }
        };
        // init
    ...
    /**
补偿temperature
原始temperature经过此method得到补偿后的temperature
     *
     * @param temp
     * @return
     */
    ...
    /**
getΔNUC和ΔVTEMP值
需要getvtemp，每次displaytemperature时调用一次即可，运算使用compensateTemp()
     */
