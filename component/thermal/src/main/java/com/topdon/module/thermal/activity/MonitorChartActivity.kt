...
\1循环监听-datasave
    ...
    private fun initChart() {
        ...
        xAxis.textSize = 9f
\1xAxis.setLabelCount(6, true)//true保证有刻度数量不变
...
\1set.fillDrawable = fillColor//set填充颜色渐变
