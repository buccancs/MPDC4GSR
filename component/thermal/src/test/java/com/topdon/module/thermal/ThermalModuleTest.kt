...
class ThermalModuleTest {
    ...
    fun testThermalDataProcessing() = runTest {
        ...
        val mockThermalData = floatArrayOf(
        ...
        assertTrue("All temperatures should be in reasonable range", 
    ...
    @Test
    fun testThermalImageDimensions() = runTest {
    ...
    fun testThermalCalibration() = runTest {
        ...
        assertTrue("Clamped temperature should be in valid range", 
            clampedTemp >= expectedMinTemp && clampedTemp <= expectedMaxTemp)
    }
    
    @Test
    fun testThermalRegionAnalysis() = runTest {
        // Test thermal region analysis (hot spots, cold spots)
        val thermalGrid = arrayOf(
