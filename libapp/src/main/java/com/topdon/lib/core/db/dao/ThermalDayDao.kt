...
@Dao
/**
 * Specialized thermal imaging component providing ThermalDayDao functionality for the IRCamera system.
 *
...
interface ThermalDayDao {
     ...
     *
     * @param
     * @param entity Parameter for operation (type: ThermalDayEntity)
     *
     */
