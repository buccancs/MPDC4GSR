...
@Dao
/**
 * Specialized thermal imaging component providing ThermalMinuteDao functionality for the IRCamera system.
 *
...
interface ThermalMinuteDao {
     ...
     *
     * @param
     * @param entity Parameter for operation (type: ThermalMinuteEntity)
     *
     */
