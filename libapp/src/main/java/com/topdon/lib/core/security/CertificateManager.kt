...
class CertificateManager(private val context: Context) {
    ...
    */
    ...
    val isValidDevice = subject.contains("CN=TOPDON") ||
    ...
    */
    fun installDeviceCertificate(certificateData: ByteArray, alias: String): Boolean {
    return try {
    ...
    */
    ...
    private fun validateCertificateChain(chain: Array<X509Certificate>, type: String) {
    if (chain.isEmpty()) {
    ...
    */
    ...
    val isValid = validHosts.contains(hostname) ||
    ...
    */
    fun validateAuthToken(token: String, maxAgeMs: Long = 300000): Boolean { // 5 minutes default
    return try {
