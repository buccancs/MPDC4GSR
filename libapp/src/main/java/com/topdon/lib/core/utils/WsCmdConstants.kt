...
object WsCmdConstants {
    ...
    const val AR_COMMAND_VERSION_GET = 3 // version号
    const val AR_COMMAND_DEV_INFO_GET: String = "AR_COMMAND_DEV_INFO_GET" // deviceinfo
    ...
    const val AR_COMMAND_BATTERY_GET: String = "AR_COMMAND_BATTERY_GET" // 获取电池info
    ...
    const val AR_COMMAND_WIFI_AP_ONOFF_SET: String = "AR_COMMAND_WIFI_AP_ONOFF_SET" // 热point开关
    const val AR_COMMAND_WIFI_AP_ONOFF_GET: String = "AR_COMMAND_WIFI_AP_ONOFF_GET"
    const val AR_COMMAND_WIFI_AP_CONFIG_SET: String = "AR_COMMAND_WIFI_AP_CONFIG_SET" // 热pointconfiguration
    ...
    const val AR_COMMAND_STORAGE_FORMAT: String = "AR_COMMAND_STORAGE_FORMAT" // format化storage空间
    const val AR_COMMAND_STORAGE_DELETE_FILE: String = "AR_COMMAND_STORAGE_DELETE_FILE" // deletefile
    const val AR_COMMAND_STORAGE_GET_FILELIST: String = "AR_COMMAND_STORAGE_GET_FILELIST" // 获取filelist
    const val AR_COMMAND_STORAGE_GET_FILECNT: String = "AR_COMMAND_STORAGE_GET_FILECNT"
    const val AR_COMMAND_STORAGE_GET_SPACEINFO: String = "AR_COMMAND_STORAGE_GET_SPACEINFO" // 获取storage空间info
    ...
    const val AR_COMMAND_VRECORD: Int = 104 // recordingstart或end
    ...
    const val AR_COMMAND_FREEZE_SET: String = "AR_COMMAND_FREEZE_SET" // image冻结
    ...
    const val AR_COMMAND_PANEL_PARAM_SET: String = "AR_COMMAND_PANEL_PARAM_SET" // 屏幕brightness
    ...
    const val APP_EVENT_TEMP_DATA: Int = 500 // temperature返回
}
