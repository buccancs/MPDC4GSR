...
object WsCmdConstants {
    ...
    const val AR_COMMAND_BATTERY_GET: String = "AR_COMMAND_BATTERY_GET" // Get/Retrieve电池info
    ...
    const val AR_COMMAND_STORAGE_GET_FILELIST: String = "AR_COMMAND_STORAGE_GET_FILELIST" // Get/Retrievefilelist
    const val AR_COMMAND_STORAGE_GET_FILECNT: String = "AR_COMMAND_STORAGE_GET_FILECNT"
    const val AR_COMMAND_STORAGE_GET_SPACEINFO: String = "AR_COMMAND_STORAGE_GET_SPACEINFO" // Get/Retrievestorage空间info
    ...
    const val AR_COMMAND_SET_CONTINUOUS_SHOOTING: String = "AR_COMMAND_SET_CONTINUOUS_SHOOTING" 
