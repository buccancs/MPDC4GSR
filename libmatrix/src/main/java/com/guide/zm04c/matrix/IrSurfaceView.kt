...
//    }
    ...
    fun doDraw(
        ...
        synchronized(this) {
            ...
            mCanvas = mHolder?.lockCanvas() // 获得画布对象，start对画布画图
...
//        )
    ...
    private var saturation = 0 // contrast 0~100
...
//        openLut = !openLut
    ...
    /**
     * 当SurfaceViewcreate的时候，调用此function
     */
    ...
    /**
     * 当SurfaceView的视图发生改变的时候，调用此function
     */
    ...
    /**
     * 当SurfaceViewdestroy的时候，调用此function
     */
