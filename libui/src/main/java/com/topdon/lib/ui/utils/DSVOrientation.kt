...
enum class DSVOrientation {
    ...
    interface Helper {
        ...
        fun getDistanceToChangeCurrent(
            childWidth: Int,
            childHeight: Int,
        ): Int
        ...
        fun hasNewBecomeVisible(lm: HorizontalLayoutManager): Boolean
    ...
    class HorizontalHelper : Helper {
        ...
        override fun getDistanceToChangeCurrent(
            childWidth: Int,
            childHeight: Int,
        ): Int {
            return childWidth
        ...
        override fun hasNewBecomeVisible(lm: HorizontalLayoutManager): Boolean {
            ...
            val isNewVisibleFromLeft = (
                lm.getDecoratedLeft(firstChild!!) > leftBound &&
        ...
        override fun offsetChildren(
            amount: Int,
            helper: RecyclerViewProxy,
        ) {
    ...
    class VerticalHelper : Helper {
        ...
        override fun isViewVisible(
            ...
            val viewTop = viewCenter.y - halfHeight
            val viewBottom = viewCenter.y + halfHeight
        ...
        override fun hasNewBecomeVisible(lm: HorizontalLayoutManager): Boolean {
            ...
            val isNewVisibleFromTop = (
                lm.getDecoratedTop(firstChild!!) > topBound &&
                    lm.getPosition(firstChild) > 0
            )
