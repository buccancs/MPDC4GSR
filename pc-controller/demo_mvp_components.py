...
def demonstrate_device_discovery():
    ...
    try:
        ...
        devices = [
            {"name": "Android-GSR-001", "type": "ANDROID_NODE", "ip": "192.168.1.100", "capabilities": ["gsr", "rgb"]},
            {"name": "Android-Thermal-002", "type": "ANDROID_NODE", "ip": "192.168.1.101", "capabilities": ["thermal", "gsr"]},
            {"name": "Shimmer-GSR-003", "type": "GSR_SENSOR", "ip": "192.168.1.102", "capabilities": ["gsr"]},
        ]
...
def demonstrate_communication_protocol():
    ...
    try:
        ...
        print(f"    Modalities: {', '.join(start_command['payload']['configuration']['modalities'])}")
