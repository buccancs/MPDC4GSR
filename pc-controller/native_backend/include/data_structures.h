 ...
 * @brief Common data structures for the native backend
 * 
 * Defines shared data structures used across the native backend components
...
/**
 * @brief Performance statistics for monitoring system health
 */
...
/**
 * @brief Synchronization marker for temporal alignment
 */
struct SyncMarker {
