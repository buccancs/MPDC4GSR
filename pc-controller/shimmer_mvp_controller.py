    ...
    def _export_device_data(self, device_id: str):
        ...
        try:
            ...
            with open(filename, 'w') as f:
                # Write header
                f.write("device_id,timestamp_ms,gsr_microsiemens,raw_value,resistance_kohm,sample_sequence\n")
    ...
    def start_visualization(self):
        ...
        def update_plot(frame):
            ...
            for i, (device_id, data) in enumerate(self.gsr_data_buffer.items()):
                ...
                recent_data = data[-self.max_display_samples:] if len(data) > self.max_display_samples else data
