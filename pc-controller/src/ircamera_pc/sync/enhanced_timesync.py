...
class EnhancedTimeSyncService:
    ...
    async def handle_time_sync_request(self, message: Dict[str, any], device_id: str) -> Dict[str, any]:
        """
        ...
        while self._is_running:
            try:
                ...
                if self._device_stats:
                    ...
                    logger.info(f"Time Sync Summary: {summary['synchronized_devices']}/{summary['total_devices']} " +
